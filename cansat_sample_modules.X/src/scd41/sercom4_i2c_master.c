...
#define SERCOM4_HANDLER(name) \
    void __attribute__((interrupt())) name(void) { \
        SERCOM4_I2C_InterruptHandler(); \
    }

SERCOM4_HANDLER(SERCOM4_0_Handler)
SERCOM4_HANDLER(SERCOM4_1_Handler)
SERCOM4_HANDLER(SERCOM4_2_Handler)
SERCOM4_HANDLER(SERCOM4_OTHER_Handler)
