...
#define SERCOM5_USART_READ_BUFFER_SIZE      64U
#define SERCOM5_USART_READ_BUFFER_9BIT_SIZE     (64U >> 1U)
...
#define SERCOM5_USART_WRITE_BUFFER_SIZE     64U
#define SERCOM5_USART_WRITE_BUFFER_9BIT_SIZE  (64U >> 1U)
...
#define SERCOM5_HANDLER(name) \
    void __attribute__((interrupt())) name(void) { \
        SERCOM5_USART_InterruptHandler(); \
    }

SERCOM5_HANDLER(SERCOM5_0_Handler)
SERCOM5_HANDLER(SERCOM5_1_Handler)
SERCOM5_HANDLER(SERCOM5_2_Handler)
SERCOM5_HANDLER(SERCOM5_OTHER_Handler)
